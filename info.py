...
API_ID = int(environ.get('API_ID', 7428575680'))
API_HASH = environ.get('API_HASH', '7428575680:AAHsWLlRhLURdnm8SZ1TS4hm8z9NtluO8iQ, "")
...
reqst_channel = environ.get('REQST_CHANNEL', 'srghvtyg2')
